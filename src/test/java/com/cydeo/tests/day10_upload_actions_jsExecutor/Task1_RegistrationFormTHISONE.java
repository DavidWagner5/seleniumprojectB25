...
import com.cydeo.utilities.ConfiguratonReader;
...
public class Task1_RegistrationFormTHISONE {
    ...
    public void registration_form_test(){
        ...
        Driver.getDriver().get(ConfiguratonReader.getProperty("registration.form.url"));
        ...
        inputBirthday.sendKeys("07/24/1997");
